...
* What tools are most often required? TODO
...
* Where do companies pay the most/least? TODO

-> Simple bar plot of extreme cities/states
...
for(pdf in pdfs) {
  pdf_convert(pdf = here::here("plots", "6_1_salary_histo.pdf"), 
              format = "png", dpi = 750)
}
```
