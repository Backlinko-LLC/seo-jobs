...
df_en %>% 
  ...
  ggplot(aes(fct_reorder(word, n), n)) +
    ...
    labs(
      ...
      title = '"Manager", "Specialist" and "Marketing" Are the\nMost Common Words Used In SEO Job Titles',
...
ggplot(
    ...
    labs(
      ...
      title = '“Senior SEO Manager”, "Remote Role Possible", “Head of SEO”,\nand “SEO Content Writer” Are the Most Common Phrases\nUsed in SEO Job Titles',
...
if(save == T){
  ggsave(here::here("plots", "1_1_jobs_cat.pdf"), width = 12, height = 13, device = cairo_pdf)
}
```
...
df_prog %>% 
  ...
  ggplot(aes(combination, n)) +
    ...
    labs(
      ...
      title = "Employers Want SEO Professionals to Know a Combination of\nHTML + CSS + JS",
...
df_req_tools %>% 
  ggplot(aes(n_tools, n)) +
    ...
    labs(
      ...
      y = NULL,
      title = "63.4% of SEO Position Cite Experience With a Specific SEO Tool"
    )
...
df_salary_cities %>% 
  ggplot(aes(avg, fct_reorder(location, avg))) +
   ...
   labs(
     x = "Average salary",
     y = NULL,
     title = "SEO Jobs In the San Francisco Bay Area\nHave the Highest Average Salaries",
...
df_salary_prog %>% 
  ...
  ggplot(aes(prog, avg)) +
    ...
    labs(
      x = "Programming language\nmentioned as requirement?",
      y = "Estimated salary",
      title = "SEOs That Can Code Get On Average\nPaid More Than Those That Can’t",
      caption = "The line shows the standard deviation of the average salary per group."
    ) +
    theme(panel.grid.major.x = element_blank(),
  ...
  ggplot(aes(prog, med)) +
   ...
   geom_text(
    ...
    labs(
      x = "Programming language\nmentioned as requirement?",
      y = "Estimated salary",
      title = "Median Income of SEOs That Can Code Is\nHigher Than For Those That Can’t",
      caption = "The line shows the standard deviation of the average salary per group."
    ) +
    theme(panel.grid.major.x = element_blank(),
          plot.title = element_text(size = 20))
...
df_dates %>% 
  ...
  ggplot(aes(week, n)) +
    ...
    labs(
      ...
      y = "Number of job offers on LinkedIn.com",
      title = "The COVID-19 Pandemic Didn’t Negatively Impact SEO Job Postings",
